...
def polish_label(titles: list[str], summaries: list[str], auto_label: str, api_key: str,
    ...
    summ_sample = "\n".join(f"- {s}" for s in summaries[:6] if s)
    system = (
        "Você nomeia temas de um acervo de bookmarks do X sobre IA, agentes, "
        "finanças, performance e startups. Dado os títulos e resumos de um cluster, "
        'responda APENAS um objeto JSON {"name": "<nome curto do tema, 2-5 palavras>", '
        '"description": "<1 frase>"}. '
