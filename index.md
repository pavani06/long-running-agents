...
- [[docs/analysis/2026-06-09-12-factor-agents/2026-06-09-12-factor-agents-integration-roadmap.md|12-Factor Agents Integration Roadmap (legacy)]] — Plans how selected 12FA patterns should enter curriculum and canonical docs.
...
- [[docs/analysis/2026-06-09-how-we-solved-context-management-in-agents/2026-06-09-how-we-solved-context-management-in-agents-integration-roadmap.md|Context Management Integration Roadmap (legacy)]] — Maps context-management gaps into canonical, curriculum, and evaluation work.
...
- [[docs/analysis/2026-06-10-eval-maturity-phases/2026-06-10-eval-maturity-phases-integration-roadmap.md|Eval Maturity Integration Roadmap (legacy)]] — Prioritizes how eval-maturity patterns should become canonical and operational guidance.
...
- [[docs/analysis/2026-06-17-macro-fund-agentic-architecture/2026-06-17-macro-fund-agentic-architecture-analysis|Macro Fund Agentic Architecture Analysis]] — Instancia os patterns de OPD e loop on-policy numa gestora macro: analistas com PI, PM com prior bayesiana, comitê com pré-compromisso, sizing RLSD, e prefix drift como cascata de drawdown. Inclui mapeamento pendente contra a estrutura ideal do repositório.
