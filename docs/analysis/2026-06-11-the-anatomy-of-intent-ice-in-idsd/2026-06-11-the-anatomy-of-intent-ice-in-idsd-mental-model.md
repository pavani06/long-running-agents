...
relates-to: ["[[docs/system-of-record|System of Record]]", "[[README|Repository README]]", "[[AGENTS|AGENTS.md]]", "[[curriculum/README|Curriculum README]]", "[[curriculum/MASTER_PLAN|Master Plan]]", "[[curriculum/INDEX|Curriculum Index]]", "[[curriculum/GLOSSARY|Glossary]]", "[[docs/canonical/intent-five-part-primitive|Intent as Five-Part Primitive]]", "[[docs/canonical/ice-craft-separation|ICE Craft Separation]]", "[[docs/canonical/application-owned-agent-control-plane|Application-Owned Agent Control Plane]]", "[[docs/canonical/hybrid-context-stack|Hybrid Context Stack]]", "[[.opencode/skills/analyze-and-improve/SKILL|Analyze and Improve Skill]]"]
...
- Transformar conhecimento externo em melhorias concretas por meio do pipeline `analyze-and-improve`: mental model do repo, extração, padrões, classificação, geração de melhorias, integração e integração curricular ([[.opencode/skills/analyze-and-improve/SKILL|.opencode/skills/analyze-and-improve/SKILL.md]]:47-57; [[.opencode/skills/analyze-and-improve/SKILL|.opencode/skills/analyze-and-improve/SKILL.md]]:171-249).
- Preservar um sistema de trabalho agentic com claim de issue, worktree isolado, execution brief, validação, draft PR, second-agent review, aprovação explícita e cleanup ([[.opencode/skills/issue-start/SKILL|issue-start]]:12-15; [[.opencode/skills/issue-review/SKILL|issue-review]]:12-15; [[.opencode/skills/issue-finish/SKILL|issue-finish]]:12-15).
...
| Issue Lifecycle | Fluxo claim -> worktree -> brief -> implement -> validate -> draft PR -> review -> explicit merge -> cleanup. | [[.opencode/skills/issue-start/SKILL|issue-start]]:78-149; [[.opencode/skills/issue-review/SKILL|issue-review]]:44-226; [[.opencode/skills/issue-finish/SKILL|issue-finish]]:50-170 |
...
| `.opencode` skills | Repository execution | Skills operacionalizam setup, review, merge, cleanup, análise, documentação e gates de valor/risco. | [[.opencode/skills/issue-start/SKILL|issue-start]]:12-15; [[.opencode/skills/orchestrator/SKILL|orchestrator]]:12-17; [[.opencode/skills/analyze-and-improve/SKILL|analyze-and-improve]]:47-57 |
...
| Recent analyses | Canonical and skills | `analyze-and-improve` converte análises em canonical docs, skills e exercícios, mantendo rastreabilidade para classificação e integração. | [[.opencode/skills/analyze-and-improve/SKILL|analyze-and-improve]]:130-148; [[docs/system-of-record|docs/system-of-record.md]]:222-299 |
...
| HoP Issue Lifecycle Skills | [[.opencode/skills/issue-start/SKILL|issue-start]]:12-15; [[.opencode/skills/issue-review/SKILL|issue-review]]:12-15; [[.opencode/skills/issue-finish/SKILL|issue-finish]]:12-15 | Active operational skills; canonical `agent-lifecycle.md` ainda pendente no SOR. |
| Analyze-and-Improve Pipeline | [[.opencode/skills/analyze-and-improve/SKILL|analyze-and-improve]]:47-57 | Active analysis skill. Repo mental model é Phase 0 antes de qualquer fonte externa. |
| Error Context Hygiene Skill | [[.opencode/skills/error-context-hygiene/SKILL|error-context-hygiene]]:13-30 | Active implementation skill. Resume erros, limpa após sucesso, não faz blind append e controla tamanho de contexto. |
| Manual Brake Skill | [[.opencode/skills/manual-brake-question-gate/SKILL|manual-brake-question-gate]]:13-21 | Active decision skill. Produz decisão experimento/build/adiar/parar. |
| Shadow Review Skill | [[.opencode/skills/shadow-review-pipeline/SKILL|shadow-review-pipeline]]:13-28 | Active governance skill. Coleta métricas TP/FP/missed-by-human/missed-by-AI antes de tornar AI review bloqueante. |
...
| Fuzzy Compiler | Modelo mental onde LLM é compiler backend, harness é optimization pass e código gerado é artefato. | [[curriculum/GLOSSARY|curriculum/GLOSSARY.md]]:182-197; [[.opencode/skills/llm-as-fuzzy-compiler/SKILL|llm-as-fuzzy-compiler]]:13-21 |
| Persona-Based Documentation | NFRs por persona especialista, carregados por agentes/reviewers conforme a tarefa. | [[curriculum/GLOSSARY|curriculum/GLOSSARY.md]]:452-466; [[.opencode/skills/persona-based-documentation/SKILL|persona-based-documentation]]:13-21 |
...
| Agentes KODA referenciam docs em `docs/canonical/operations/`, `docs/canonical/product/` e `docs/canonical/architecture/`, mas as leituras recentes registram esses paths como NOT_FOUND. | [[.opencode/agents/koda-hop-init-basic|koda-hop-init-basic]]:28-35; [[.opencode/agents/hop-live-whatsapp-tester|hop-live-whatsapp-tester]]:22-31; [[docs/analysis/2026-06-12-idsd-method/2026-06-12-idsd-method-mental-model|IDSD mental model]]:217 |
| Alguns gates citados por `issue-review` são exemplos mais amplos que não existem no `package.json` atual; os scripts reais são `lint`, `lint:fix`, `test:unit` e `test:integration`. | [[.opencode/skills/issue-review/SKILL|issue-review]]:50-71; [[package.json|package.json]]:8-13; [[docs/analysis/2026-06-12-idsd-method/2026-06-12-idsd-method-mental-model|IDSD mental model]]:218 |
