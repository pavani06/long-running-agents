...
sources: ["[[docs/analysis/2026-06-07-full-walkthrough-workflow-for-ai-coding-matt-pocock/classification|WFAC Classification]]", "[[docs/analysis/2026-06-07-full-walkthrough-workflow-for-ai-coding-matt-pocock/patterns|WFAC Patterns]]"]
---
...
**Source:** `docs/analysis/2026-06-07-full-walkthrough-workflow-for-ai-coding-matt-pocock/classification.md`
...
- `docs/analysis/2026-06-07-full-walkthrough-workflow-for-ai-coding-matt-pocock/classification.md` — classification and evidence for all 15 patterns
- `docs/analysis/2026-06-07-full-walkthrough-workflow-for-ai-coding-matt-pocock/patterns.md` — 15 extracted pattern definitions with 6 fields each
- `docs/analysis/2026-06-07-full-walkthrough-workflow-for-ai-coding-matt-pocock/mental-model.md` — repository mental model, curriculum structure, and existing gaps
