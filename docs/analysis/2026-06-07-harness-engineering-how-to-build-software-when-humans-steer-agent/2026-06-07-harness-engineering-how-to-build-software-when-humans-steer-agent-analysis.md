...
relates-to: ["[[docs/canonical/resolver-based-context-progressive-disclosure|Resolver-Based Context Progressive Disclosure]]", "[[docs/canonical/measured-harness-evolution-lifecycle|Measured Harness Evolution Lifecycle]]", "[[docs/canonical/qa-to-backlog-feedback-loop|QA to Backlog Feedback Loop]]", "[[docs/canonical/closed-loop-agent-operating-system|Closed-Loop Agent Operating System]]", "[[docs/canonical/invariant-compensation-split|Invariant Compensation Split]]", "[[docs/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-analysis/2026-06-09-12-factor-agents/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-analysis|12-Factor Agents Analysis]]", "[[docs/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-analysis/2026-06-10-eval-maturity-phases/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-analysis|Eval Maturity Analysis]]", "[[docs/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-analysis/2026-06-10-harness-evolution-metodos-construcao/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-analysis|Harness Evolution Analysis]]"]
