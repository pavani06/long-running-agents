...
relates-to: ["[[docs/analysis/2026-06-09-12-factor-agents/2026-06-09-12-factor-agents-analysis|12FA Analysis]]", "[[docs/canonical/owned-agent-control-loop|Owned Agent Control Loop]]", "[[docs/canonical/deterministic-tool-dispatch|Deterministic Tool Dispatch]]", "[[docs/canonical/error-context-hygiene|Error Context Hygiene]]", "[[docs/canonical/serializable-pause-resume-state|Serializable Pause/Resume State]]"]
