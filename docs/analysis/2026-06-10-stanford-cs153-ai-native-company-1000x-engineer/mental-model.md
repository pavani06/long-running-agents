...
| Analyze-and-improve pipeline | `.opencode/skills/analyze-and-improve/SKILL.md` | Active analysis workflow; it defines repository mental modeling as Phase 0 and writes `mental-model.md` plus `mental-model.yaml` before external source analysis (`.opencode/skills/analyze-and-improve/SKILL.md:46-57`, `.opencode/skills/analyze-and-improve/SKILL.md:123-190`). |
