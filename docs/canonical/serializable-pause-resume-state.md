...
**Classification:** Partial Coverage — repo has richer state model, but different mechanism (per `docs/analysis/2026-06-09-pattern-classification.md`)
...
- `docs/analysis/2026-06-09-agentic-patterns.md` — pattern 4 definition
