...
- [[.opencode/agents/hop-orchestrator-rezek.md|orchestrator agent]] provides governance-persona coordination as the HoP orchestrator, demonstrating role-specific agent scopes.
...
- [[.opencode/agents/hop-orchestrator-rezek.md|orchestrator agent]] — governance-persona coordination agent.
