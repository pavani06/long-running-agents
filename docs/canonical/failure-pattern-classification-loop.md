...
- [[docs/analysis/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-analysis|analysis]]:47-57 — Garbage Collection Day meta-loop: categorize slop patterns, build systematic solutions to eliminate classes of misbehavior.
- [[docs/analysis/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-analysis|analysis]]:193 — slop accumulating weekly as a failure pattern; GC Day as the mitigation.
- [[docs/analysis/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-analysis|analysis]]:201-210 — synthesis: the harness is a system that learns; GC Day is the meta-loop.
- [[docs/analysis/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-patterns|patterns]]:137-159 — Weekly Harness Garbage Collection Loop pattern: categorized failure classes, new or updated guardrails, reduced need for synchronous correction.
- [[docs/analysis/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent/2026-06-07-harness-engineering-how-to-build-software-when-humans-steer-agent-classification|classification]]:276-291 — Partial Coverage classification with NOT_FOUND evidence for weekly cadence, categorization rubric, and documented slop-to-guardrail pipeline.
