...
| [[.opencode/skills/issue-start/SKILL.md|issue-start skill]] | O execution brief do issue-start tem objective e success criteria. O Five-Part Intent expande o objective para descricao + constraints + conexoes, e os success criteria para cenarios de sucesso + cenarios de falha. |
