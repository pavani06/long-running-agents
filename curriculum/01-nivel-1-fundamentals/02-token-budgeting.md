...
tags: ["curriculo-conteudo", "token-budgeting", "context-management", "knowledge-management", "arquitetura", "monitoramento", "durable-facts", "session-handoff"]
relates-to: ["[[docs/canonical/head-tail-context-truncation|Head-Tail Context Truncation]]", "[[docs/canonical/stable-harness-prompt|Stable Harness Prompt]]", "[[docs/canonical/error-context-hygiene|Error Context Hygiene]]", "[[docs/canonical/token-economics-gap-filling|Token Economics of Gap-Filling]]", "[[docs/canonical/intent-five-part-primitive|Intent as Five-Part Primitive]]"]
