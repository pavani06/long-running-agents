...
tags: ["curriculo-conteudo", "knowledge-management", "stack-tooling", "diagnostico", "mhc-backend", "evals", "arquitetura"]
relates-to: ["[[docs/canonical/error-context-hygiene|Error Context Hygiene]]", "[[docs/canonical/owned-agent-control-loop|Owned Agent Control Loop]]", "[[docs/canonical/head-tail-context-truncation|Head-Tail Context Truncation]]", "[[docs/analysis/2026-06-09-12-factor-agents/2026-06-09-12-factor-agents-patterns|12FA Patterns]]"]
