...
nivel: 3
aliases: ["KODA N3", "KODA arquitetura avançada", "KODA nível 3", "falhas coordenação"]
tags: ["curriculo-conteudo", "nivel-3", "mhc-backend", "arquitetura", "context-management", "observability", "decision-discipline", "error-handling"]
