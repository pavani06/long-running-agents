...
sequenceDiagram
    ...
    O-->>H: Escala apenas se max_iterations for atingido
```
...
- `curriculum/05-core-concepts/05-state-persistence.md`, para aprofundar persistência de estado.
- `curriculum/05-core-concepts/08-evaluation-rubrics.md`, para entender rubrics como instrumentos de julgamento.
...
### Cartão 26: Autoria contamina julgamento
...
### Cartão 27: Coerência não é verdade
...
### Cartão 31: Context window não é memória confiável
...
### Cartão 32: Generator precisa de liberdade
...
### Cartão 33: Evaluator precisa de poder
...
### Cartão 34: Independência exige critérios
...
### Cartão 35: Audit log é narrativa factual
...
### Cartão 36: Max iterations é segurança
...
### Cartão 37: Human-in-the-Loop é saída honesta
...
### Cartão 38: Shared memory precisa de fronteira
...
### Cartão 39: Message passing precisa de registro
...
### Cartão 40: State files ensinam o time
...
### Cartão 42: Claims precisam de evidência
...
### Cartão 43: O cliente vê simplicidade
...
### Cartão 44: Sycophancy não some com tom firme
...
### Cartão 45: Separação reduz carga
...
### Cartão 46: Critério sem fonte é opinião
...
### Cartão 47: A segunda tentativa deve ser diferente
...
### Cartão 48: Aprovação deve ter motivo
...
### Cartão 49: Erro residual deve ser medido
...
### Cartão 50: Nível 2 é consequência
...
### Cartão 51: Autoria contamina julgamento
...
### Cartão 52: Coerência não é verdade
...
### Cartão 56: Context window não é memória confiável
...
### Cartão 57: Generator precisa de liberdade
...
### Cartão 58: Evaluator precisa de poder
...
### Cartão 59: Independência exige critérios
...
### Cartão 60: Audit log é narrativa factual
...
### Cartão 61: Max iterations é segurança
...
### Cartão 62: Human-in-the-Loop é saída honesta
...
### Cartão 63: Shared memory precisa de fronteira
...
### Cartão 64: Message passing precisa de registro
...
### Cartão 65: State files ensinam o time
...
### Cartão 67: Claims precisam de evidência
...
### Cartão 68: O cliente vê simplicidade
...
### Cartão 69: Sycophancy não some com tom firme
...
### Cartão 70: Separação reduz carga
...
### Cartão 71: Critério sem fonte é opinião
...
### Cartão 72: A segunda tentativa deve ser diferente
...
### Cartão 73: Aprovação deve ter motivo
...
### Cartão 74: Erro residual deve ser medido
...
### Cartão 75: Nível 2 é consequência
...
### Cartão 76: Autoria contamina julgamento
...
### Cartão 77: Coerência não é verdade
...
### Cartão 81: Context window não é memória confiável
...
### Cartão 82: Generator precisa de liberdade
...
### Cartão 83: Evaluator precisa de poder
...
### Cartão 84: Independência exige critérios
...
### Cartão 85: Audit log é narrativa factual
...
### Cartão 86: Max iterations é segurança
...
### Cartão 87: Human-in-the-Loop é saída honesta
...
### Cartão 88: Shared memory precisa de fronteira
...
### Cartão 89: Message passing precisa de registro
...
### Cartão 90: State files ensinam o time
